...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"], ["category.id"], name=op.f("fk__category__parent_id__category"), ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["root_id"], ["category.id"], name=op.f("fk__category__root_id__category"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM("forming", "paid", "delivering", "done", "cancelled", name="order_status_enum"),
        ...
        sa.ForeignKeyConstraint(
            ["client_id"], ["client.id"], name=op.f("fk__order__client_id__client"), ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["order_id"], ["order.id"], name=op.f("fk__order_item__order_id__order"), ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["product_id"], ["product.id"], name=op.f("fk__order_item__product_id__product"), ondelete="CASCADE"
        ),
...
def downgrade() -> None:
    ...
    order_status_enum = postgresql.ENUM("forming", "paid", "delivering", "done", "cancelled", name="order_status_enum")
